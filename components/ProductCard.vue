<template>
    <!-- component -->
    <div
        class="mx-auto mt-11 w-80 transform overflow-hidden rounded-lg bg-white dark:bg-slate-800 shadow-md duration-300 hover:shadow-lg">
        ...
        <div class="p-4">
            ...
            <div>
                <button class="w-full bg-white rounded-md text-center my-2 hover:bg-slate-400">Buy now</button>
            </div>
        </div>
    </div>
</template>
